...
test_path = r'C:\Users\bhilw\OneDrive\Documents\Contentshield\ACCURATE MODEL\Real Life Violence Dataset\Test'  # Add your test path here
...
def save_model_hdf5(model, filename):
    with h5py.File(filename, 'w') as f:
        for key, value in model.state_dict().items():
            f.create_dataset(key, data=value.cpu().numpy())  # Move to CPU and convert to numpy
