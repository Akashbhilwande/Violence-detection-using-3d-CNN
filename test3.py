...
test_violence_path = r'C:\Users\bhilw\OneDrive\Documents\Contentshield\ACCURATE MODEL\Real Life Violence Dataset\Test\Violence'
test_nonviolence_path = r'C:\Users\bhilw\OneDrive\Documents\Contentshield\ACCURATE MODEL\Real Life Violence Dataset\Test\NonViolence'
...
# Variables to track accuracy, loss, and confusion matrix
correct = 0
total = 0
test_loss = 0.0
all_predictions = []
...
plt.plot([accuracy] * len(all_predictions), label='Accuracy')
plt.xlabel('Batch')
plt.ylabel('Accuracy')
...
# Plot Loss Graph
plt.figure(figsize=(10, 5))
plt.plot([test_loss / len(test_loader)] * len(all_predictions), label='Test Loss')
plt.xlabel('Batch')
plt.ylabel('Loss')
